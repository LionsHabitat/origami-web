...
const faq: QuestionAnswer[] = [
  ...
  {
    id: 16,
    question: `Who can benefit from using Open Oracle Origami?`,
    answer: `Open Oracle Origami is available for any individual or group seeking real-world data to empower and safeguard their smart contract execution. It offers a robust and customizable framework for establishing decentralized oracle networks. Currently, hundreds of teams involved in dApps, blockchains, industry consortiums, enterprise projects, and other ventures rely on the service's secure and tamper-proof inputs and outputs for their smart contract operations.`,
  },
]
export default faq
